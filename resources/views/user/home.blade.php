    ...
    <section class="home-slider-area">
      <div class="swiper home-slider-container default-slider-container">
        <div class="swiper-wrapper home-slider-wrapper slider-default">
          <div class="swiper-slide" data-bg-img="assets/img/slider/slider-bg.webp">
        ...
        <div class="row">
          <div class="col-12">
            <div class="section-title shape-center text-center">
              ...
              <h2 class="title">CHOOSE YOUR PET</h2>
            </div>
          </div>
        </div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-gutter-43">
          <div class="col">
            ...
            <div class="product-category-item">
              <div class="thumb">
                <a href="shop.html"><img src="assets/img/shop/category/1.webp" width="200" height="200" alt="Image-HasTech"></a>
              </div>
              <div class="content">
                <h3 class="title"><a href="shop.html">Cats</a></h3>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="product-category-item">
              <div class="thumb">
                <a href="shop.html"><img src="assets/img/shop/category/2.webp" width="200" height="200" alt="Image-HasTech"></a>
              </div>
              <div class="content">
                <h3 class="title"><a href="shop.html">Gold Fish</a></h3>
              </div>
            </div>
            <!--== End Product Category Item ==-->
          </div>
          <div class="col">
            ...
            <div class="product-category-item">
              <div class="thumb">
                <a href="shop.html"><img src="assets/img/shop/category/3.webp" width="200" height="200" alt="Image-HasTech"></a>
              </div>
              <div class="content">
                <h3 class="title"><a href="shop.html">Parrot</a></h3>
              </div>
            </div>
            <!--== End Product Category Item ==-->
          </div>
          <div class="col">
            ...
            <div class="product-category-item">
              <div class="thumb">
                <a href="shop.html"><img src="assets/img/shop/category/4.webp" width="200" height="200" alt="Image-HasTech"></a>
              </div>
              <div class="content">
                <h3 class="title"><a href="shop.html">Dog</a></h3>
              </div>
            </div>
            <!--== End Product Category Item ==-->
          </div>
          <div class="col">
            ...
            <div class="product-category-item">
              <div class="thumb">
                <a href="shop.html"><img src="assets/img/shop/category/5.webp" width="200" height="200" alt="Image-HasTech"></a>
              </div>
              <div class="content">
                <h3 class="title"><a href="shop.html">Rabbits</a></h3>
              </div>
            </div>
            <!--== End Product Category Item ==-->
          </div>
            ...
            <div class="product-item">
              <div class="product-thumb">
                <a href="single-product.html">
                  <img src="{{str_replace(public_path().'',"",$value->img)}}" width="270" height="320" alt="Image-HasTech">
                </a>
              </div>
              <div class="product-info">
                <h4 class="title"><a href="single-product.html">{{$value->title}}</a></h4>
                <p>{{$value->desc}}</p>
                <div class="prices">
                  <span class="price">{{$value->price}}</span>
                </div><br/>
                <button type="submit" name="addCart" class="btn btn-danger" style="color: darkred">ADD TO CART</button>
