        ...
        <div class="row">
          <div class="col-md-6 col-lg-3">
            <div class="widget-item widget-about">
              ...
              <p class="desc">My pet is an online store for all pet supplies. which is why everything we
                do at My Pet Store is designed to help your pets live a healthy and happy life..
              </p>
              ...
              <div id="widgetId-3" class="collapse widget-collapse-body">
                <div class="collapse-body">
                  <div class="widget-contact-info">
                    <p class="contact-info-desc">If you have any question. contact us at <a href="contact.html">my-pet-store@email.com</a></p>
                    <div class="contact-item">
                      <div class="icon">
                        <i class="pe-7s-map-marker"></i>
                      </div>
                      <div class="info">
                        <p>Maadi - Cairo - Egypt. <br>123, 9 ST.</p>
                      </div>
                    </div>
                    <div class="contact-item phone-info">
                      ...
                      <div class="info">
                        <p><span>Have any Question</span> <br><a href="tel://01279547848">+0 127 954 7848</a></p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="footer-bottom-content">
              <p class="copyright">Copyright © 2022 All rights reserved.      Team CS94</p>
              <div class="payment">
